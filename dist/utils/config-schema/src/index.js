...
async function generate() {
    ...
    const schema = generator.getSchemaForSymbols([ROOT_IDENTIFIER, ...relevantConfigurations.map(f => f.identifier)], true);
        ...
        anyOf: [
            ...
            },
            {
                ...
                oneOf: relevantConfigurations.reduce((prev, p) => {
                    const description = `${schema.definitions[p.identifier].description || ''}\n\nFor more details and documentation: https://graphql-code-generator.com/docs/plugins/${p.pluginName}\n\n=> Make sure to include "@graphql-codegen/${p.pluginName}" in your package.json file and install your dependencies.\n\n`;
                    return [
                        ...prev,
                        {
                            const: p.pluginName,
